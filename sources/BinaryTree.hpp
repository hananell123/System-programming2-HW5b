...
template<typename T>
BinaryTree<T>& BinaryTree<T>::add_root(T data){
    if(root== nullptr){
        (BTnode*)root;
        size++;
    }
...
template<typename T>
BinaryTree<T>& BinaryTree<T>::add_left(T oldData,T newData){
    bool flag= false;
...
template<typename T>
BinaryTree<T>& BinaryTree<T>::add_right(T oldData,T newData) {
}
iterator_preorder BinaryTree<T>::begin_preorder(){
    return iterator_preorder(root);
}
template<typename T>
iterator_preorder<T> BinaryTree<T>::end_preorder(){
    BTnode<T>* tempPtr=root;
    while (tempPtr->right== nullptr && tempPtr->right== nullptr){
    ...
    return iterator_preorder<T>(tempPtr);
}
*/
}
